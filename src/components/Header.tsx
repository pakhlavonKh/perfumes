...
export const Header = () => {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-gradient-gold backdrop-blur-md border-b border-border">
        ...
        <div className="flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-8">
            <button
              ...
              className="text-sm font-medium text-background transition-colors"
            >
              {t('nav.about')}
            </button>
            <button
